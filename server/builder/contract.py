...
class SessionBurnCause(BaseModel):
    model_config = ConfigDict(extra="forbid")
...
class SessionBurnSpike(BaseModel):
    model_config = ConfigDict(extra="forbid")
    ...
    lines_removed: int
    seconds: int
    causes: list[SessionBurnCause] = Field(max_length=3)
    files_changed: int | None = None
    commits: int | None = None
    unreadable: bool | None = None


class SessionBurn(BaseModel):
    model_config = ConfigDict(extra="forbid")

    tokens: int | None = None
    cache_read_share: float | None = Field(default=None, ge=0.0, le=1.0)
    barren_share: float | None = Field(default=None, ge=0.0, le=1.0)
    unreadable_share: float | None = Field(default=None, ge=0.0, le=1.0)
    segments: int
    ...
    spikes: list[SessionBurnSpike] | None = Field(default=None, max_length=3)
    spikes_needed: int | None = None
